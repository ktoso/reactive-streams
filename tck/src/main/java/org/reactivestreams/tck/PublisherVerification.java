...
public abstract class PublisherVerification<T> {
      ...
      public void run(Publisher<T> pub) throws Throwable {
        ...
        final ManualSubscriber<T> sub = new ManualSubscriberWithSubscriptionSupport<T>(env) {
          ...
          public void onNext(T element) {
            ...
            // request more right away, the Publisher must break the reccursion
   ...
   */
  public void completedPublisherTest(PublisherTestRun<T> body) throws Throwable { // TODO: Not used, find tests for completed publisher or remove
